...
const TweetMobile = () => {
   const [inputData, setInputDataa] = useState("");
   // console.log(tweets);

   const handleChange = (event) => {
      setInputDataa(event.target.value);
   };

   const handleAddTaskClick = () => {
      alert("Desculpa, aqui ainda não está pronto!")
   };
      ...
      <div className="tweets">
         <div className="top-tweets">
            <Link to="/home">
               <svg
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  className="r-13gxpu9 r-4qtqp9 r-yyyyoo r-18yzcnr r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-yc9v9c"
               >
                  <g>
         ...
         <div className="tweetar">
            ...
            <div className="tweetar-write">
               ...
               <div className="tweetar-everyone">
                  <div>
                     <svg
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        className="r-13gxpu9 r-4qtqp9 r-yyyyoo r-10ptun7 r-1sp7lne r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1janqcz"
                     >
                        <g>
               ...
               <div className="tweetar-options">
                  ...
                  <div className="tweetar-options--btns">
                     {inputData && (
                        <button className="tweetar-options--btns-more">
                           <svg
                              viewBox="0 0 24 24"
                              aria-hidden="true"
                              className="r-13gxpu9 r-4qtqp9 r-yyyyoo r-10ptun7 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-1janqcz"
                           >
                              <g>
